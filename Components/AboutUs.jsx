...
function AboutUs() {
    return (
        <section className="w-full bg-[#0f172a] px-8 lg:px-[100px] py-16 min-h-screen text-white flex flex-col justify-center">
            {/* <!-- About Us Top --> */}
            <div className="flex flex-col lg:flex-row items-center gap-10 w-full ">
                ...
                {/* <!-- Right Image --> */}
                <div className="flex-1">
                    <div className="rounded-xl overflow-hidden shadow-lg w-64 h-64 mx-auto">
